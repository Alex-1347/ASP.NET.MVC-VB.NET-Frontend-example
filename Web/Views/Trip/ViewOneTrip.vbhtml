        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header card-header-danger">
                    <h4 class="card-title">Delete Trip</h4>
                </div>
                <div class="card-body">
                    @Using Html.BeginForm("Delete", "Trip", New With {.id = Model.TripID}, FormMethod.Post, New With {.OnSubmit = "ShowWaitGif(event)"})
                        @<div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            @Html.EditorFor(Function(model) model.UserID, New With {.htmlAttributes = New With {.class = "form-control", .placeholder = "00000000-0000-0000-0000-000000000000", .disabled = "disabled", .readonly = "readonly"}})
...
.title = ModelMetadata.FromLambdaExpression(Function(x As Model.CreateTripModel) x.Trip.FromLocationID, ViewData).Description}})
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        @Html.DropDownListFor(Function(model) model.Trip.TripType, DirectCast(ViewData("TripTypeList"), List(Of SelectListItem)), New With {.class = "form-control", .disabled = "disabled", .readonly = "readonly"})
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-1">
                                        @Html.EditorFor(Function(model) model.Trip.Scheduled, New With {.htmlAttributes = New With {.class = "form-control", .disabled = "disabled", .readonly = "readonly"}})
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-1">
                                        @Html.EditorFor(Function(model) model.Trip.BidEnabled, New With {.htmlAttributes = New With {.class = "form-control", .disabled = "disabled", .readonly = "readonly"}})
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        @Html.EditorFor(Function(model) model.Trip.DepartureDateTime, New With {.htmlAttributes = New With {.Class = "form-control", .disabled = "disabled", .readonly = "readonly"}})
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <div class="checkbox">
                                            @Html.DropDownListFor(Function(model) model.Trip.FareType, DirectCast(ViewData("FireTypeList"), List(Of SelectListItem)), New With {.class = "form-control", .disabled = "disabled", .readonly = "readonly"})
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            @Html.EditorFor(Function(model) model.Trip.PaymentMethodId, New With {.htmlAttributes = New With {.class = "form-control", .placeholder = "00000000-0000-0000-0000-000000000000", .disabled = "disabled", .readonly = "readonly"}})
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            @Html.EditorFor(Function(model) model.Trip.PromotionID, New With {.htmlAttributes = New With {.class = "form-control", .placeholder = "00000000-0000-0000-0000-000000000000", .disabled = "disabled", .readonly = "readonly"}})
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        @Html.TextAreaFor(Function(model) model.Trip.Note, 3, 80, New With {.htmlAttributes = New With {.class = "form-control", .disabled = "disabled", .readonly = "readonly"}})
                        ...
                        @<div class="text-center" style="margin-top: 18px; margin-bottom: 18px;">
                            <input id="button-create-ride-type-submit" class="btn btn-danger btn-round" type="submit" value="Delete Trip" />
                        </div>
                    End Using
                </div>
            </div>
