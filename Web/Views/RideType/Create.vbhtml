@Code
    ViewData("Title") = "Create Ride Type"
...
@Section Scripts
    <script type="text/javascript" src="@Url.Content("~/Assets/Admin/JS/customized/CreateRideType.js")"></script>
End Section
    ...
    <div class="row" id="content-panel">
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                    @Using Ajax.BeginForm("RideType/Create", "Service", New AjaxOptions() With {.HttpMethod = "POST", .OnBegin = "OnCreateRideTypeBegin", .OnSuccess = "OnCreateRideTypeSuccess", .OnFailure = "OnCreateRideTypeFailure"})
                        @<div class="row">
                            <div class="col-md-6">
                        ...
                        @<div class="text-center" style="margin-top: 18px; margin-bottom: 18px;">
                            <input id="button-create-ride-type-submit" class="btn btn-danger btn-round" type="submit" value="Create Ride Type" />
                        </div>
                    End Using
                </div>
            </div>
